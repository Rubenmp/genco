...
use crate::core::file_system::directory_browser::directory_browser::check_dir;
...
mod tests {
    ...
    use crate::java::generator::dto::java_visibility::JavaVisibility::Public;
    use crate::java::generator::java_method_generator;
