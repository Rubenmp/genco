...
mod tests {
    ...
    use crate::java::generator::dto::java_class_skeleton::JavaClassSkeleton;
    use crate::java::generator::dto::java_visibility::JavaVisibility::{Package, Protected, Public};
    use crate::java::generator::file_generator::java_class_skeleton_generator::java_class_skeleton_generator::generate;
