...
pub fn simple_write(original: &YamlNode, to_add: &YamlNode) -> YamlNode {
    ...
    YamlNode::new(original.get_file_path())
}
...
mod tests {
    ...
    use crate::domain::usecase::yaml::parser::yaml_writer::simple_write;
