...
use crate::domain::usecase::yaml::parser::yaml_parser::yaml_parser::parse;

/// Overrides a YAML file [original_yaml_file] adding the tree structure from another YAML file
...
/// It panics if the file does not contain a valid YAML structure.
...
mod tests {
    ...
    use crate::domain::usecase::yaml::parser::yaml_writer::yaml_writer::overwrite;
    ...
    fn overwrite_test() {
        ...
        fs::copy(copy_file_path, &original_file_path).expect("Replace file with copy");
    }
